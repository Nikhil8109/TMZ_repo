		...
		showTorHeim: function(oEvent){
            ...
            var playWithFadeOut = function(audioElement) {
                ...
                audioElement.onloadedmetadata = () => {
                    var fadeOutStartTime = audioElement.duration - 5; // Start fade-out 10 seconds before the end
				...
				this.x = setInterval(function () {
					if (oModel.getProperty("/stop") === false) {
						...
						if (minutes === 0 && seconds === 0) {
                            ...
                            // Setze die Lautstärke auf 30%
                            me._oLastAudio.volume = 0.2;

                            // Warte 5 Sekunden, dann pausiere, setze das Audio zurück und lösche den Timer
                            setTimeout(() => {
                                me._oLastAudio.pause();
