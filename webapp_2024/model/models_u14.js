	...
	return {
		...
		createModel: function () {
			var data = {
				...
				"allGroupsAndTeams":["teamsGruppeH","teamsGruppeI","teamsGruppeJ","teamsGruppeK"],
				"allGroupsAndGames":["spieleGruppeH","spieleGruppeI","spieleGruppeJ","spieleGruppeK"],
				"allGroupsAndPoints":["pktGruppeH","pktGruppeI","pktGruppeJ","pktGruppeK"],
				"allGroupsAndGoalDiffs":["torDiffGruppeH","torDiffGruppeI","torDiffGruppeJ","torDiffGruppeK"],
				"allGroupsAndGoals":["toreGruppeH","toreGruppeI","toreGruppeJ","toreGruppeK"],
				"teamsGruppeH":["1. FSV Mainz 05", "FC Schalke 04","Legia Warschau","SV Vaihingen", "SK Slavia Prag","Karlsruher SC"],
				"spieleGruppeH":[0,0,0,0,0,0],
				"pktGruppeH":[0,0,0,0,0,0],
				"torDiffGruppeH":[0,0,0,0,0,0],
				"toreGruppeH":[0,0,0,0,0,0],
				"teamsGruppeI":["FC Metz","Eintracht Frankfurt","Atalanta Bergamo","Adana Demirspor","VfB Stuttgart"],
				"spieleGruppeI":[0,0,0,0,0],
				"pktGruppeI":[0,0,0,0,0],
				"torDiffGruppeI":[0,0,0,0,0],
				"toreGruppeI":[0,0,0,0,0],
				"teamsGruppeJ":["NK Maribor","CFR Cluj","Galatasaray Istanbul","SC Freiburg","FC Augsburg"],
				"spieleGruppeJ":[0,0,0,0,0],
				"pktGruppeJ":[0,0,0,0,0],
				"torDiffGruppeJ":[0,0,0,0,0],
				"toreGruppeJ":[0,0,0,0,0],
				"teamsGruppeK":["Roter Stern Belgrad","FC St. Pauli","Tottenham Hotspur","FK Sarajevo","Juventus F.C."],
				"spieleGruppeK":[0,0,0,0,0],
				"pktGruppeK":[0,0,0,0,0],
				"torDiffGruppeK":[0,0,0,0,0],
				"toreGruppeK":[0,0,0,0,0],
				"teamsCurrGroup":"",
				"gamesCurrGroup":"",
				"pointsCurrGroup":"",
				"goalDiffCurrGroup":"",
				...
				"teams": [
						...
						{"url": "pics/nberg.png", "name": "1. FC Nurnberg"} ,
						{"url": "pics/1. FSV Mainz 05.png", "name": "1. FSV Mainz 05"} ,
						{"url": "pics/Borussia Dortmund.png", "name": "Borussia Dortmund"} ,
						{"url": "pics/Borussia Monchengladbach.png", "name": "Borussia Monchengladbach"} ,
						...
						{"url": "pics/SG Sonnenhof Grossaspach.png", "name": "SG Sonnenhof Grossaspach"} ,
						{"url": "pics/SG Opfingen.png", "name": "SG Opfingen"}  ,
						...
						{"url": "pics/SW Donau.png", "name": "SW Donau"}  ,
						{"url": "pics/TSG Ehingen.png", "name": "TSG Ehingen"} ,
						{"url": "pics/SGM Alb-Hochstrass.png", "name": "SGM Alb-Hochstrass"}  ,
				...
				"gifs": [
					{
						...
						"url": "pics/gifs/goal1.gif",
						"name": "All"
					},{
						"url": "pics/gifs/goal2.gif",
						"name": "All"
					},{
